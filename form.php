...
try {
    ...
    $uploadResult = uploadFiles($targetFolder, $_FILES['metadata']);
...
// Upload meta file in target folder
function uploadFiles($targetFolder, $metaFile)
{
    $status = 'error';
    $messages = [];
